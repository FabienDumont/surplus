...
public class ExchangeValueTests
{
  ...
  {
    Assert.Equal("1 coat of Coat = 20 yard of Linen", ExchangeValue.Between(Coat(), Linen()).ToString());
  }
  ...
  public void Exchange_value_relates_use_values_of_different_kinds()
  {
    ...
    Assert.Throws<DomainException>(() => ExchangeValue.Between(Linen(), Linen(2m)));
  }
