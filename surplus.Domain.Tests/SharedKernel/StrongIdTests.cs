...
using Surplus.Domain.SharedKernel.StrongIds;

namespace Surplus.Domain.Tests.SharedKernel;
...
public class StrongIdTests
{
  ...
  [Fact]
  public void An_id_reads_as_its_underlying_value()
  {
    var value = Guid.CreateVersion7();

    Assert.Equal(value.ToString(), Id<TestTag>.From(value).ToString());
  }
